    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <!-- Search bar for searching the items -->
            ...
            if ($page == "" || $page == 1) {
                ...
                // $post_query_count .= "ORDER BY post_id DESC ";
                $find_count = mysqli_query($con, $post_query_count);
                $count = mysqli_num_rows($find_count);
                 
                 $count = ceil($count / $per_page);//removing the  decimal using the ceil function...
                


                //query for post looping
                ...
                <hr>
                <p style="font-size:2vw;" ><?php echo $post_content; ?>
